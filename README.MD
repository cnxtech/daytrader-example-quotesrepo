...
#### Maven
        ...
        1.  Change the following property in daytrader-quotes/pom.xml to your DockerHub user name:
    
            <docker.image.prefix>${user.name}</docker.image.prefix>
               
        3.  Change the following key-value in daytrader-quotes/env/external/k8s/quotes-deployment.yaml to your DockerHub user name
        
            image: YOUR_DOCKERHUB_USERNAME/daytrader-gateway:4.0.18
        
        4.  The following property in daytrader-quotes/pom.xml is also worth noting. You do not have to change it, but if you do, change the above key-value accordingly.
...
#### Configure kubectl to access the cluster
        ...
        1.  For Minikube,  
                ...
                a.  $ minikube --memory 8192 --cpus 2 start
        
                b.  $ kubectl config use-context minikube   
        
        2.  For EKS, 
        
                a.  $ kubectl config use-context eks
...
#### Create a Deployment to run the application in one or more pods
    ...
    Notes: A Deployment also creates the specified number of PODs and a ReplicaSet to manage the lifecycle of the pods
	    ...
	    1.  $ cd daytrader-quotesapp\daytrader-quotes\env\external\k8s
		...
		3.  $ kubectl get pods
            ...
            daytrader-quotes-87b5658f4-889gp    1/1     Running   0          6m   
        ...
        4.  $ kubectl logs <POD_NAME>
            ...
            ##  You should see : Tomcat started on port(s): 4443 (https). If not see Troubleshooting
...
#### Create a Service to load balance requests across the Pods
	...
	communicate with application's directly. Instead they should talk to applications via service. To create the service,
        ...
        2.  $ kubectl get services
            ...
            daytrader-quotes	ClusterIP   10.100.17.24     <none>        443/TCP         3d
...
### Pods
        ...
        2.  Access the pod (application) through the port forwarder
	            ...
	            a.	$ kubectl port-forward <POD_NAME> 8888:4443  ## This command forwards local port 8888 to port 4443 of your pod
       
        	    	Forwarding from 127.0.0.1:8888 -> 4443
...
### Services
        ...
        1.	Access the service (application) through the API Server
    			...
    			b.	$ curl -k http://localhost:8001/api/v1/namespaces/default/services/https:daytrader-quotes:/proxy/health      
...
#### Local
   		...
   		1. Make sure the application is running
     			...
     			$ cd daytrader-quotesapp
       			$ daytrader-quotes\env\external\bin\start_server
	    ...
	    3.	Stop the application after reviewing the APIs
      			...
      			$ cd daytrader-quotesapp	
            	$ daytrader-quotes\env\external\bin\stop_server
